...
if (mysqli_connect_errno())
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
    ...
    $sql= "CALL taatencion_laboratorio();";
      ...
      <!--sidebar end-->
                ...
                <section id="main-content">
                    ...
                    <!--  end  Context Classes  -->
                            ...
                            <div class="col-lg-6 " style='display:none;' id="oculto">
                                            ...
                                            while ($row=mysqli_fetch_row($result))
                                                ...
                                                echo "
                                                    ...
                                                    <div class='thumb'>
                                                        ...
                                                        <input type='button' value='Recibir Muestra' onclick='mostrar()'>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            Resultados entregados en el dia:
                        </div>
